...
speed = 1#フレームレート
idx = 0
tmr = 0#idxと合わせてゲームの進行を管理
floor = 0#現在の改装
fl_max = 1#到達した階層数（最大値)
welcome = 0#[Welcom to floor***]というmsgを表示する時間

pl_x = 0
pl_y = 0#上と合わせて主人公のダンジョンの位置
pl_d = 0#direction主人公の向き
pl_a = 0#anime主人公のアニメパターン
pl_lifemax = 0#主人公のライフ最大値
pl_life = 0#主人公のライフ
pl_str = 0#strength 主人公の攻撃力
food = 0#食糧
potion = 0#保持しているポーションの数
blazegem = 0#保持しているblazeの数
treasure = 0#宝箱やまゆに触った時に出てくるもの

emy_name = ""#敵の名前
emy_lifemax = 0#敵のライフ最大値
emy_life = 0#敵のライフ
emy_str = 0#敵の攻撃力
emy_x = 0#敵を戦闘画面に表示する時の座標
emy_y = 0
emy_step = 0#敵を(前に出たように見せるために)下に下げる値
emy_blink = 0#敵のダメージアクションの際点滅する回数

dmg_eff = 0#主人公がダメージを受けた時に画面を揺らすのに使う
btl_cmd = 0#戦闘のコマンドの値
